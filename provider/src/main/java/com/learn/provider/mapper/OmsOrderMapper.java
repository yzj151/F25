...
import com.learn.api.model.OmsOrderExample;
import java.util.List;

import com.learn.api.model.OmsOrderItem;
...
public interface OmsOrderMapper {
    ...
    @Results({
        ...
        @Result(property = "orderItemList",javaType = List.class,column="id",
                many = @Many(select="com.learn.provider.mapper.OmsOrderItemMapper.selectItemByOrderid")),
        @Result(property = "historyList",javaType = List.class,column="id",
                many = @Many(select="com.learn.provider.mapper.OmsOrderOperateHistoryMapper.selectHistoryByOrderId"))
